...
dir_input = '/Users/joeybernhardt/Documents/chlamytippee/cell-images/cell-images-jpg/'

// specify directory with photos for comparison
dir_compare = '/Users/joeybernhardt/Desktop/MEE/Images/2 - Photos for comparison/'
...
//------------------------------------------------------------------------------
  ...
  if (seg=='threshold') {
    ...
    selectWindow(list[i]);
    setThreshold(0, 164, "black & white");
    run("Convert to Mask");
    run("Invert");}
